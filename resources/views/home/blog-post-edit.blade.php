    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-12 col-lg-10">
                ...
                <form action="{{route('user.blog.update', ['id'=>$blog->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    <div class="mb-2">
                        <label for="blogTitle" class="form-label">Blog Title<span class="text-danger">*</span></label>
                        <input type="text" id="blogTitle" class="form-control" name="name" placeholder="Blog Title" required value="{{$blog->title}}">
                    </div>
                    @error('name')
                    ...
                    <div class="mb-3 ps-3 row align-items-center">
                        ...
                        <div class="col-sm-2 ms-3 d-flex align-items-center justify-content-center border rounded"
                            ...
                            <img id="profilePreview" src="{{asset('uploads/posts')}}/{{$blog->image}}"
                                 alt="Select a Photo"
                    ...
                    <div class="mb-2">
                        ...
                        <textarea id="description" name="description" rows="8" class="form-control" placeholder="Write your description...">{{$blog->description}}</textarea>
                    </div>
                    @error('description')
                        <span class="alert alert-danger text-center">{{$message}}</span>
                    @enderror
